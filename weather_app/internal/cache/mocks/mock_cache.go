...
// Source: github.com/PunitNaran/weather_app/internal/cache (interfaces: Cache)
...
import (
	...
	configs "github.com/PunitNaran/weather_app/configs"
...
func (m *MockCache) Get(arg0 string) ([]configs.ForecastPeriod, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].([]configs.ForecastPeriod)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockCache) Set(arg0 string, arg1 []configs.ForecastPeriod) error {
	m.ctrl.T.Helper()
